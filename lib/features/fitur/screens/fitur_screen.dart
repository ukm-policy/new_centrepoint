...
const _roles = [
  ...
  _RoleData(
    ...
    items: [
      ...
      _MenuItem(icon: Icons.info_outline, label: 'Info Internal Bidang', route: '/fitur/bidang', implemented: false),
    ],
  ),
  _RoleData(
    title: 'Ketua Bidang',
    ...
    items: [
      _MenuItem(icon: Icons.qr_code, label: 'Generate QR Absensi', route: '/admin/qr-generator', implemented: false),
      _MenuItem(icon: Icons.event_available_outlined, label: 'Kelola Kegiatan Bidang', route: '/admin/kegiatan', implemented: false),
      _MenuItem(icon: Icons.how_to_reg_outlined, label: 'Kelola Absensi Anggota', route: '/absensi/riwayat-sekret'),
      _MenuItem(icon: Icons.stars_outlined, label: 'Kelola Poin Anggota', route: '/admin/poin', implemented: false),
  ...
  _RoleData(
    ...
    items: [
      _MenuItem(icon: Icons.payments_outlined, label: 'Uang Khas Semua Anggota', route: '/admin/uang-khas', implemented: false),
      _MenuItem(icon: Icons.verified_outlined, label: 'Verifikasi Pembayaran', route: '/admin/uang-khas/verifikasi', implemented: false),
      _MenuItem(icon: Icons.bar_chart, label: 'Rekap Keuangan', route: '/admin/keuangan', implemented: false),
  ...
  _RoleData(
    ...
    items: [
      _MenuItem(icon: Icons.event_available_outlined, label: 'Kelola Kegiatan Semua Bidang', route: '/admin/kegiatan', implemented: false),
      _MenuItem(icon: Icons.article_outlined, label: 'Kelola Berita & Pengumuman', route: '/admin/berita', implemented: false),
      _MenuItem(icon: Icons.campaign_outlined, label: 'Kirim Pengumuman', route: '/admin/pengumuman/buat', implemented: false),
